...
# Creates HTML code to include the samptux icons + link to www.statistica.it/gianluca
samptux <- function(path="assets/logo.png",width="2.0%",text="") {
  paste0('<span><a href="https://alim.gitee.io/"><img src="',path,'" title="Go home" width="',width,'"></a>',text,'</span>')
...
add_email <- function() {
  paste0('&nbsp;<a href="mailto:ad938@medschl.cam.ac.uk"; title="Email me">',icons::icon_style(icons::fontawesome("envelope",style = "solid"),scale=.8,fill="#bcc0c4"),'</a>&nbsp;')
}

add_website <- function() {
  paste0('&nbsp;<a href="https://alim.gitee.io/"; title="Visit my website">',icons::icon_style(icons::fontawesome("firefox"),scale=.8,fill="#bcc0c4"),'</a>&nbsp;')
}


# linkedin <- function(alt="") {
#   icons="images/linkedin.png"
#   link="https://www.linkedin.com/in/XXXXX/"
#   htmltools::tags$a(.noWS = c("after-begin", "before-end"),
#                     href = link,
#                     htmltools::tags$img(src = icons, alt = alt, width = "32", height = "32", style = "border: none;")
#   )
# }
github <- function(alt="") {
  icons="images/github.png"
  link="https://www.github.com/adayim"
  htmltools::tags$a(.noWS = c("after-begin", "before-end"),
                    href = link,
                    htmltools::tags$img(src = icons, alt = alt, width = "32", height = "32", style = "border: none;")
  )
...
#   icons="images/scholar.png"
#   link="https://scholar.google.com/citations?user=XXXX=en"
#   htmltools::tags$a(.noWS = c("after-begin", "before-end"),
#                     href = link,
#                     htmltools::tags$img(src = icons, alt = alt, width = "32", height = "32", style = "border: none;")
#   )
...
researchgate <- function(alt="") {
  icons="images/researchgate.png"
  link="https://www.researchgate.net/profile/Alim-Dayim-2"
  htmltools::tags$a(.noWS = c("after-begin", "before-end"),
                    href = link,
                    htmltools::tags$img(src = icons, alt = alt, width = "32", height = "32", style = "border: none;")
  )
